...
class BaseKotlinOperation {
    companion object {
        ...
        /*
        fun setDelayedLongClick(
            handler: Handler,
            longClickView: View,
            delayMillis: Long,
            longClickListener: OnLongClickListener?
        ) {
            longClickView.setOnTouchListener(object : OnTouchListener {
        ...
        */
        ...
        /*
        fun setDelayLongClick(handler: Handler, v: View, t: Long) {
            v.setOnTouchListener(object : View.OnTouchListener {
                ...
                override fun onTouch(v: View?, event: MotionEvent?): Boolean {
                    ...
                    when (event.action) {
                        ...
                        MotionEvent.ACTION_DOWN -> {
                            handler.removeCallbacks(performLongClick)
                            mLastMotionX = x.toInt()
                            mLastMotionY = y.toInt()
                            handler.postDelayed(performLongClick, t)
                        }
