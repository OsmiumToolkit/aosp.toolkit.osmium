...
import aosp.toolkit.perseus.base.Accessing.Companion.openPackage
...
class DisableAppActivity : AppCompatActivity() {
    private val appIconViewList = mutableListOf<aosp.toolkit.perseus.DisableAppActivity.AppIconView>()
    ...
    private fun initialize() {
        ...
        floatingActionButton.setOnClickListener {
            startActivityForResult(Intent(this, aosp.toolkit.perseus.DisableAppActivity.DisableSelectActivity::class.java), 0)
        }
        floatingActionButton.setOnLongClickListener {
            startActivity(Intent(this, aosp.toolkit.perseus.ShortcutDisableActivity::class.java))
            Thread {
